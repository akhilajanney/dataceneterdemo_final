    ...
    return (
      <div>
        <div className='sidebar'>
          ...
          <Link to='/health'>
            <div className={'sidebarmenu'} title="System Health" onClick={() => linkClicked(3)} style={Background}>
          ...
          <Link to='/alerts'>
            <div className={'sidebarmenu'} title="Alerts" onClick={() => linkClicked(4)} style={Background}>
              <i style={{ fontSize: '20px', color: '#000', paddingTop: '8px', paddingLeft: '5px', transform: 'rotate(30deg)' }} className="fas fa-bell"></i>
            </div>
          </Link>
          ...
          <Link to='/ghosttools'>
            <div className={'sidebarmenu'} title="Tools" onClick={() => linkClicked(6)} style={Background}>
