...
import AssetTrackHistory from './components/Pages/AssetTrackHistory';
import AssetAlert from "./components/Pages/Assetalert";
import GhostServer from './components/Pages/GhostServer';
import RackTracking from './components/Pages/RackTracking.jsx';
      ...
      return (
        ...
        <Router>
          ...
          <Routes>
            ...
            <Route exact path="/assettrackhistory" element={<AssetTrackHistory />} />
            <Route exact path="/assetalert" element={<AssetAlert />} />
            <Route exact path="/ghosttools" element={<Tools />} />
